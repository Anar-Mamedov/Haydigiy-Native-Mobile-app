...
describe('SizeSelectionSheet — bedene özel indirim rozeti', () => {
  ...
  it('shows the whole discount on a size of an already discounted product', () => {
    // Regresyon: 209,99 TL'lik ürün %5 indirimle 199,99 TL, S bedeni 159,99 TL. Sheet'in fiyat
    // kutusu S için %24 gösteriyor; rozet indirimli fiyata göre %20 diyordu.
    renderWithTamagui(
      <SizeSelectionSheet
        {...sheetBaseProps}
