...
type SizeSelectionSheetProps = {
  ...
  firstPrice?: number;
  /**
   * Ürünün bedene özel olmayan fiyatı ve indirim öncesi fiyatı. `price` seçili bedenin fiyatına
   * dönebildiği için ayrı verilir; bundan ucuza satılan ve alınabilen bedenin köşesinde, o beden
   * seçilince fiyat kutusunda görünecek toplam indirim rozeti ("%24") çıkar.
   */
            ...
            <XStack flexWrap="wrap" gap="$2">
              {isLoadingVariants ? (
                ...
                variants.map((variant) => {
                  ...
                  const discountRate = available ? resolveVariantDiscountRate(variant.price, productPricing) : undefined;
                  return (
                    <XStack
                      accessibilityLabel={
                        !isApprovedForSale
