...
import { WHATSAPP_BRAND_COLOR } from '@/lib/theme/colors';
...
/**
 * WhatsApp marka logosu. Lucide setinde marka ikonu bulunmadığı için ham SVG
 * olarak taşınır; rengi her iki temada da sabit kaldığından varsayılanı merkezi
 * marka sabitinden gelir.
 */
export function WhatsappIcon({ color = WHATSAPP_BRAND_COLOR, size = 24 }: WhatsappIconProps) {
  return (
